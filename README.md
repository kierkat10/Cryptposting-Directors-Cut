# Cryptposting: Director's Cut
This repository, made by the same creator of Cryptposting, is a small update to the original Cryptposting mod intended to fix bugs, add the indefinitely-pending PR, and change a couple things for a more fulfilling experience only in Glitchkat10's eyes (no other users may contribute to this repository).
